...
export const HERO_CONFIG = {
  ...
  marketData: [
    { sym: 'REACT', val: '18.3.1', chg: 'NOMINAL', up: true, fillPct: 95, fillColor: '#006494' },
    { sym: 'NEXT.JS', val: '14.2.1', chg: 'OPTIMIZED', up: true, fillPct: 90, fillColor: '#2DD4F5' },
    { sym: 'TS', val: '5.4.5', chg: 'TYPESAFE', up: true, fillPct: 88, fillColor: '#006494' },
  ...
  networkCoverage: [
    { name: 'Architecture', members: 'Scalable Patterns', pct: 92, color: '#006494' },
